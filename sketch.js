...
function setup() {
	...
	box1.shapeColor="red";
	box2=createSprite((width/2)-100,650-45,20,100);
	box2.shapeColor="red";
	box3=createSprite((width/2)+100,650-45,20,100);
	box3.shapeColor="red";
	...
	box2body = Bodies.rectangle((width/2)-100,650-45,20,100, {isStatic:true});
	World.add(world,box1body);
	box3body = Bodies.rectangle((width/2)+100,650-45,20,100, {isStatic:true});
	World.add(world,box1body);
	//Create a Ground
